...
# 配置
TMUX_WINDOWS = ["sweep1","sweep2","sweep3","sweep4","sweep5","sweep6","sweep7","sweep8"]  # 监控的tmux窗口名称列表
CHECK_INTERVAL = 60  # 检查间隔（秒）
LOG_FILE = "log.txt"

# 每个窗口的SLURM命令映射
WINDOW_COMMANDS = {
    "sweep1": "srun -N 1 -n 1 -X -u -p normal --gres=gpu:1 -c 2 --mem=1M -t 0-96:00:00 wandb agent kuangpenghao-shanghaitech-university/pt-noise-test/by0nwzrx",
    "sweep2": "srun -N 1 -n 1 -X -u -p normal --gres=gpu:1 -c 2 --mem=1M -t 0-96:00:00 wandb agent kuangpenghao-shanghaitech-university/pt-noise-test/by0nwzrx",
    "sweep3": "srun -N 1 -n 1 -X -u -p normal --gres=gpu:1 -c 2 --mem=1M -t 0-96:00:00 wandb agent kuangpenghao-shanghaitech-university/pt-noise-test/by0nwzrx",
    "sweep4": "srun -N 1 -n 1 -X -u -p normal --gres=gpu:1 -c 2 --mem=1M -t 0-96:00:00 wandb agent kuangpenghao-shanghaitech-university/pt-noise-test/by0nwzrx",
    "sweep5": "srun -N 1 -n 1 -X -u -p normal --gres=gpu:1 -c 2 --mem=1M -t 0-96:00:00 wandb agent kuangpenghao-shanghaitech-university/pt-noise-test/by0nwzrx",
    "sweep6": "srun -N 1 -n 1 -X -u -p normal --gres=gpu:1 -c 2 --mem=1M -t 0-96:00:00 wandb agent kuangpenghao-shanghaitech-university/pt-noise-test/by0nwzrx",
    "sweep7": "srun -N 1 -n 1 -X -u -p normal --gres=gpu:1 -c 2 --mem=1M -t 0-96:00:00 wandb agent kuangpenghao-shanghaitech-university/pt-noise-test/by0nwzrx",
    "sweep8": "srun -N 1 -n 1 -X -u -p normal --gres=gpu:1 -c 2 --mem=1M -t 0-96:00:00 wandb agent kuangpenghao-shanghaitech-university/pt-noise-test/by0nwzrx"
}
